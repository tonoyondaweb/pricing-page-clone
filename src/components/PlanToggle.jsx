export default function PlanToggle(props) {
    return (
        <div className="flex justify-around items-center py-10 flex-wrap gap-5">
            <h1 className="font-serif text-3xl">{'Plans & Pricing'}</h1>
            <div className="flex items-center gap-x-5">
                <span className={`text-base ${props.toggle ?
                    "text-grey-100/50" : "text-grey"
                    }`}>MONTHLY</span>
                <div className="h-7 w-12 bg-green-100 flex flex-col justify-center rounded-full px-1 cursor-pointer" onClick={props.clickHandler}>
